...
This repository contains my solution for the Engineering Task.
...
The solution is designed to make the data easier to use for self-service reporting by business teams.
